...
public class AGEx2a {
  ...
  private static void matrices(int program) {
	...
	Matrix4f model = Matrix4f.rotate(45, 1, 1, 0);//.multiply(Matrix4f.translate(0, 0, 0));
	...
	Matrix4f view = Matrix4f.translate(0, 0, -1f);
	...
	Matrix4f projection = Matrix4f.orthographic(-3.0f, 3.0f, -3.0f, 3.0f, -3.0f, 3.0f);
	// Matrix4f projection = Matrix4f.orthographic(-ratio, ratio, -1f, 1f, -1f, 1f);
	// Matrix4f projection = Matrix4f.orthographic(-2f, 2f, -2f, 2f, -2f, 2f);
...
//        "in vec3 fragmentColor;",
        "out vec4 frag_color;",
        "void main() {",
//        "  frag_color = vec4(fragmentColor, 1);",
